...
from timestamp import currenttime
...
# Response: QueryOut containing the flower_class predicted and timestamp (200)
def predict_flower(query_data: QueryIn):
    output = {"flower_class": predict(query_data),"timestamp":currenttime()}
    return output
